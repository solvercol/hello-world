<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmAdminActividadesReclamos.aspx.cs" Inherits="Modules.Reclamos.Catalogos.FrmAdminActividadesReclamos" %>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <div id="divPanelShow">
                ...
                <asp:button id="btnNew" runat="server" Visible="true" OnClick="BtnNewClick" text="Nueva Actividad Reclamos"></asp:button>
            </td>
        </tr>
    </table>
                    ...
                    OnItemDataBound="RptListadoItemDataBound">
	                    <headertemplate>
		                    <tr>
		                        ...
		                        <th style="width:190px;">Actividad</th>
	                    ...
	                    <itemtemplate>
		                    <tr>
                                ...
                                <td align="left"><asp:Literal ID="litActividadDescripcion" runat="server"></asp:Literal></td>
			                    <td align="center">
