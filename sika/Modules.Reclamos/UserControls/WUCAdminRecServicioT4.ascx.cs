...
{
    public partial class WUCAdminRecServicioT4 : ViewUserControl<AdminRecServicioT4Presenter, IAdminRecServicioT4View>, IAdminRecServicioT4View
    {
        #region Members
        ...
        public void LoadSubCategoriaReclamo(List<DTO_ValueKey> items)
        {
            if (items.Any())
            {
                items = items.OrderBy(x => x.Value).ToList();
            }
            wddSubCategoriaReclamo.DataSource = items;
            wddSubCategoriaReclamo.TextField = "Id";
            wddSubCategoriaReclamo.ValueField = "Value";
            wddSubCategoriaReclamo.DataBind();

            wddSubCategoriaReclamo.SelectedItemIndex = 0;
        }
        ...
        public string SubCategoriaReclamo
        {
            get
            {
                return wddSubCategoriaReclamo.SelectedValue;
            }
            set
            {
                wddSubCategoriaReclamo.SelectedValue = value;
            }
        }
        ...
        public int IdResponsableCategoriaReclamo
        {
            get
            {
                if (ViewState["AdminServicio4_IdResponsableCategoriaReclamo"] == null)
                    ViewState["AdminServicio4_IdResponsableCategoriaReclamo"] = 0;

                return Convert.ToInt32(ViewState["AdminServicio4_IdResponsableCategoriaReclamo"]);
            }
            set
            {
                ViewState["AdminServicio4_IdResponsableCategoriaReclamo"] = value;
            }
        }
