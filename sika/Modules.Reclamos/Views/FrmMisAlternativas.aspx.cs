...
{
    public partial class FrmMisAlternativas : ViewPage<MisAlternativasPresenter, IMisAlternativasView>, IMisAlternativasView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Mis Alternativas");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/Reclamos/Resources/ReportViewer/RptVistaMisAlternativas.rdlc");
