...
{
    public partial class FrmMisActividades : ViewPage<MisActividadesPresenter, IMisActividadesView>, IMisActividadesView
    {
        #region Page Events
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/Reclamos/Resources/ReportViewer/RptVistaMisActividades.rdlc");
