...
{
    public partial class FrmReclamosPorResponsable : ViewPage<ReclamosPorResponsablePresenter, IReclamosPorResponsableView>, IReclamosPorResponsableView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Reclamos Por Responsable");
        }
        ...
        public void LoadViewReclamos(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/Reclamos/Resources/ReportViewer/RptVistaReclamosPorResponsable.rdlc");
