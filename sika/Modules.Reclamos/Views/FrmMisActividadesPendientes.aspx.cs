...
namespace Modules.Reclamos.Views
{
    public partial class FrmMisActividadesPendientes : ViewPage<MisActividadesPendientesPresenter, IMisActividadesPendientesView>, IMisActividadesPendientesView
    {
        ...
        {
            ImprimirTituloVentana("Mis Actividades Pendientes");
        }
        ...
        public void LoadViewReclamos(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/Reclamos/Resources/ReportViewer/RptVistaMisActividadesPendientes.rdlc");
