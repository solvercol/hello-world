...
{
    public partial class FrmSeguimientoTotalSolicitudes : ViewPage<SeguimientoTotalSolicitudesPresenter, ISeguimientoTotalSolicitudesView>, ISeguimientoTotalSolicitudesView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Seguimiento Total Solicitudes");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/AccionesPC/Resources/ReportViewer/RptSeguimientoTotalSolicitudes.rdlc");
