...
{
    public partial class FrmMisSolicitudesPendientes : ViewPage<MisSolicitudesPendientesPresenter, IMisSolicitudesPendientesView>, IMisSolicitudesPendientesView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Mis Solicitudes Pendientes");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/AccionesPC/Resources/ReportViewer/RptMisSolicitudesPendientes.rdlc");
