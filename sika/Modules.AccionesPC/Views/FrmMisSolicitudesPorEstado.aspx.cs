...
{
    public partial class FrmMisSolicitudesPorEstado : ViewPage<MisSolicitudesPorEstadoPresenter, IMisSolicitudesPorEstadoView>, IMisSolicitudesPorEstadoView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Mis Solicitudes Por Estado");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/AccionesPC/Resources/ReportViewer/RptMisSolicitudesPorEstado.rdlc");
