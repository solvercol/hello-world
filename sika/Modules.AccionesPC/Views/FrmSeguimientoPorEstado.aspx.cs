...
{
    public partial class FrmSeguimientoPorEstado : ViewPage<SeguimientoPorEstadoPresenter, ISeguimientoPorEstadoView>, ISeguimientoPorEstadoView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Seguimiento Por Estado");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/AccionesPC/Resources/ReportViewer/RptSeguimientoPorEstado.rdlc");
