<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WucLogSolicitudesApc.ascx.cs" Inherits="Modules.AccionesPC.UserControls.WucLogSolicitudesApc" %>
