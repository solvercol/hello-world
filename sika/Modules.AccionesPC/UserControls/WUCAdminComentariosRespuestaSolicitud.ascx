<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WUCAdminComentariosRespuestaSolicitud.ascx.cs" Inherits="Modules.AccionesPC.UserControls.WUCAdminComentariosRespuestaSolicitud" %>
    ...
    <tr>
        <td >
            <div style="padding:3px; text-align:right;">
               ...
               <%-- <asp:Button ID="btnNuevoRespuestaCliente" enabled="false" runat="server" Text="Enviar Respuesta Cliente" OnClick="BtnAddRespuestaCliente_Click" />--%>
            </div>
        </td>
    </tr>
