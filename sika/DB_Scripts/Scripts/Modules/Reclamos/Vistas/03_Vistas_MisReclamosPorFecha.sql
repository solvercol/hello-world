IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'Vistas_MisReclamosPorFecha') AND type in (N'P', N'PC'))
DROP PROCEDURE Vistas_MisReclamosPorFecha
GO
-- =============================================
-- Author:		Solver
...
-- Description:
-- =============================================
CREATE PROCEDURE Vistas_MisReclamosPorFecha
(
	@dateFrom datetime
	,@dateEnd datetime
