IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'Reclamos_GetAllAsesores') AND type in (N'P', N'PC'))
DROP PROCEDURE Reclamos_GetAllAsesores
GO
-- =============================================
-- Author:		Solver
...
-- Description:
-- =============================================
CREATE PROCEDURE Reclamos_GetAllAsesores
