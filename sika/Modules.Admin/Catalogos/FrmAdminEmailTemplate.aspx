<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmAdminEmailTemplate.aspx.cs" Inherits="Modules.Admin.Catalogos.FrmAdminEmailTemplate" %>
...
<div style="padding:3px; text-align:right;">
  <asp:button id="btnNew" runat="server" Visible="true" OnClick="BtnNewClick" text="New Template"></asp:button>
</div>
