...
{
    public class SeguimientoPorTipoPresenter : Presenter<ISeguimientoPorTipoView>
    {
        ...
        public void LoadView()
        {
            try
            {
                var dt = _solicitudesAdoService.GetVistaSolicitudesMisPendientes(View.FechaFilterFrom, View.FechaFilterTo, View.ServerHostPath, View.IdModule, "segtipo"
