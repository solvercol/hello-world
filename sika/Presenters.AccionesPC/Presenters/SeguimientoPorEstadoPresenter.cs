...
namespace Presenters.AccionesPC.Presenters
{
    public class SeguimientoPorEstadoPresenter : Presenter<ISeguimientoPorEstadoView>
    {
        ...
        public SeguimientoPorEstadoPresenter(ISfTBL_ModuloAPC_AreasManagementServices areasService, ISolicitudesAPCAdoService solicitudesAdoService)
        {
        ...
        public void LoadView()
        {
            try
            {
                var dt = _solicitudesAdoService.GetVistaSolicitudesMisPendientes(View.FechaFilterFrom, View.FechaFilterTo, View.ServerHostPath, View.IdModule, "segestado"
