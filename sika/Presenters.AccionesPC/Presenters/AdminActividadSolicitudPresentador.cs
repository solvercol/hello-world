...
namespace Presenters.AccionesPC.Presenters
{
    public class AdminActividadSolicitudPresentador : Presenter<IAdminActividadSolicitudView>
    {
        ...
        private readonly ISendEmail _sendmailSercices;
        ...
        public AdminActividadSolicitudPresentador(ISfTBL_ModuloAPC_SolicitudManagementServices solicitudService,
                                                ...
                                                ISendEmail sendmailSercices)
        {
            _solicitudService = solicitudService;
            _sendmailSercices = sendmailSercices;
        ...
        public void LoadActividadSolicitud()
        {
            ...
            try
            {
                ...
                if (model != null)
                {
                    ...
                    View.CanRegister = (model.EstadoActividad == "Registrada" || model.EstadoActividad == "Programada") &&
                                       (View.UserSession.IdUser == model.CreateBy ||
                                        View.UserSession.IdUser == model.IdResponsableEjecucion ||
                                        View.UserSession.IdUser == model.IdResponsableSeguimiento ||
                                        View.UserSession.IsInRole("AdministradoresAPC"));
        ...
        public void MarcarCerradaActividadReclamo()
        {
            ...
            try
            {
                ...
                if (model != null)
                {
                    ...
                    _sendmailSercices.EnviarCorreoelectronicoActividadApcRealizada(model.IdActividad, View.UserSession);
        ...
        public void CancelarActividadReclamo()
        {
            ...
            try
            {
                ...
                if (model != null)
                {
                    ...
                    _sendmailSercices.EnviarCorreoelectronicoActividadApcCancelada(model.IdActividad, View.UserSession,
