...
namespace Presenters.AccionesPC.Presenters
{
    public class SeguimientoPorAutorPresenter : Presenter<ISeguimientoPorAutorView>
    {
        ...
        public SeguimientoPorAutorPresenter(ISfTBL_ModuloAPC_AreasManagementServices areasService, ISolicitudesAPCAdoService solicitudesAdoService)
        {
        ...
        public void LoadView()
        {
            try
            {
                var dt = _solicitudesAdoService.GetVistaSolicitudesMisPendientes(View.FechaFilterFrom, View.FechaFilterTo, View.ServerHostPath, View.IdModule, "segautor"
