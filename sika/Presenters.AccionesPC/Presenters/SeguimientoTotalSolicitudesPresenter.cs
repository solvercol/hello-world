...
namespace Presenters.AccionesPC.Presenters
{
    public class SeguimientoTotalSolicitudesPresenter : Presenter<ISeguimientoTotalSolicitudesView>
    {
        ...
        public SeguimientoTotalSolicitudesPresenter(ISfTBL_ModuloAPC_AreasManagementServices areasService, ISolicitudesAPCAdoService solicitudesAdoService, ISfTBL_Admin_OptionListManagementServices optionListService)
        {
