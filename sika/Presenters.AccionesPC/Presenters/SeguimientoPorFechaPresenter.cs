...
namespace Presenters.AccionesPC.Presenters
{
    public class SeguimientoPorFechaPresenter : Presenter<ISeguimientoPorFechaView>
    {
        ...
        public SeguimientoPorFechaPresenter(ISfTBL_ModuloAPC_AreasManagementServices areasService, ISolicitudesAPCAdoService solicitudesAdoService)
        {
        ...
        public void LoadView()
        {
            try
            {
                var dt = _solicitudesAdoService.GetVistaSolicitudesMisPendientes(View.FechaFilterFrom, View.FechaFilterTo, View.ServerHostPath, View.IdModule, "segfecha"
