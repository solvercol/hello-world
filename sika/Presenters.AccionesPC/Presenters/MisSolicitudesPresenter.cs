...
{
    public class MisSolicitudesPresenter : Presenter<IMisSolicitudesView>
    {
        ...
        public MisSolicitudesPresenter(ISfTBL_ModuloAPC_AreasManagementServices areasService, ISolicitudesAPCAdoService solicitudesAdoService, ISfTBL_Admin_OptionListManagementServices optionListService)
        {
        ...
        public void LoadView()
        {
            try
            {
                var dt = _solicitudesAdoService.GetVistaMisSolicitudes(View.FechaFilterFrom, View.FechaFilterTo, View.ServerHostPath, View.IdModule, "missolicitudes"
