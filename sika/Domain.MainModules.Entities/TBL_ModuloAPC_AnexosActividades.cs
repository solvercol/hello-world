...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_ModuloAPC_AnexosActividades: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public decimal IdAnexoActividad
        {
            get { return _idAnexoActividad; }
            set
            {
                if (_idAnexoActividad != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'IdAnexoActividad' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _idAnexoActividad = value;
                    OnPropertyChanged("IdAnexoActividad");
                }
            }
        }
        private decimal _idAnexoActividad;
        ...
        public decimal IdActividad
        {
            ...
            set
            {
                if (_idActividad != value)
                {
                    ...
                    if (!IsDeserializing)
                    {
                        if (TBL_ModuloAPC_Actividades != null && TBL_ModuloAPC_Actividades.IdActividad != value)
                        {
                            TBL_ModuloAPC_Actividades = null;
                        }
                    }
                    _idActividad = value;
        ...
        [DataMember]
        public TBL_ModuloAPC_Actividades TBL_ModuloAPC_Actividades
        {
            get { return _tBL_ModuloAPC_Actividades; }
            set
            {
                if (!ReferenceEquals(_tBL_ModuloAPC_Actividades, value))
                {
                    var previousValue = _tBL_ModuloAPC_Actividades;
                    _tBL_ModuloAPC_Actividades = value;
                    FixupTBL_ModuloAPC_Actividades(previousValue);
                    OnNavigationPropertyChanged("TBL_ModuloAPC_Actividades");
                }
            }
        }
        private TBL_ModuloAPC_Actividades _tBL_ModuloAPC_Actividades;
        ...
        private void FixupTBL_Admin_Usuarios(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloAPC_AnexosActividades.Contains(this))
            {
                previousValue.TBL_ModuloAPC_AnexosActividades.Remove(this);
            }
    
            if (TBL_Admin_Usuarios != null)
            {
                if (!TBL_Admin_Usuarios.TBL_ModuloAPC_AnexosActividades.Contains(this))
                {
                    TBL_Admin_Usuarios.TBL_ModuloAPC_AnexosActividades.Add(this);
                }
        ...
        private void FixupTBL_Admin_Usuarios1(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloAPC_AnexosActividades1.Contains(this))
            {
                previousValue.TBL_ModuloAPC_AnexosActividades1.Remove(this);
            }
    
            if (TBL_Admin_Usuarios1 != null)
            {
                if (!TBL_Admin_Usuarios1.TBL_ModuloAPC_AnexosActividades1.Contains(this))
                {
                    TBL_Admin_Usuarios1.TBL_ModuloAPC_AnexosActividades1.Add(this);
                }
        ...
        private void FixupTBL_ModuloAPC_Actividades(TBL_ModuloAPC_Actividades previousValue)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (TBL_ModuloAPC_Actividades != null)
            {
                if (!TBL_ModuloAPC_Actividades.TBL_ModuloAPC_AnexosActividades.Contains(this))
                {
                    TBL_ModuloAPC_Actividades.TBL_ModuloAPC_AnexosActividades.Add(this);
                }
    
                IdActividad = TBL_ModuloAPC_Actividades.IdActividad;
            }
            if (ChangeTracker.ChangeTrackingEnabled)
            {
                if (ChangeTracker.OriginalValues.ContainsKey("TBL_ModuloAPC_Actividades")
                    && (ChangeTracker.OriginalValues["TBL_ModuloAPC_Actividades"] == TBL_ModuloAPC_Actividades))
                {
                    ChangeTracker.OriginalValues.Remove("TBL_ModuloAPC_Actividades");
                }
                else
                {
                    ChangeTracker.RecordOriginalValue("TBL_ModuloAPC_Actividades", previousValue);
                }
                if (TBL_ModuloAPC_Actividades != null && !TBL_ModuloAPC_Actividades.ChangeTracker.ChangeTrackingEnabled)
                {
                    TBL_ModuloAPC_Actividades.StartTracking();
                }
            }
        }
