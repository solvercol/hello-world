...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_Admin_Roles: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<TBL_Admin_Usuarios> TBL_Admin_Usuarios1
        {
            get
            {
                if (_tBL_Admin_Usuarios1 == null)
                {
                    _tBL_Admin_Usuarios1 = new TrackableCollection<TBL_Admin_Usuarios>();
                    _tBL_Admin_Usuarios1.CollectionChanged += FixupTBL_Admin_Usuarios1;
                }
                return _tBL_Admin_Usuarios1;
            }
            set
            {
        ...
        private TrackableCollection<TBL_Admin_Usuarios> _tBL_Admin_Usuarios1;
        ...
        private void FixupTBL_Admin_Usuarios1(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (TBL_Admin_Usuarios item in e.NewItems)
                {
                    if (!item.TBL_Admin_Roles1.Contains(this))
                    {
                        item.TBL_Admin_Roles1.Add(this);
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        if (!item.ChangeTracker.ChangeTrackingEnabled)
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("TBL_Admin_Usuarios1", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (TBL_Admin_Usuarios item in e.OldItems)
                {
                    if (item.TBL_Admin_Roles1.Contains(this))
                    {
                        item.TBL_Admin_Roles1.Remove(this);
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("TBL_Admin_Usuarios1", item);
                    }
                }
            }
        }
