...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_ModuloDocumentos_Estados: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupTBL_ModuloDocumentos_Documento(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                ...
                {
                    item.TBL_ModuloDocumentos_Estados = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.TBL_ModuloDocumentos_Estados, this))
                    {
                        item.TBL_ModuloDocumentos_Estados = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
