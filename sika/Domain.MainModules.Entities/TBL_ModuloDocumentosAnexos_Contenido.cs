...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_ModuloDocumentosAnexos_Contenido: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int IdContenido
        {
            ...
            set
            {
                if (_idContenido != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'IdContenido' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _idContenido = value;
                    OnPropertyChanged("IdContenido");
                }
            }
        }
