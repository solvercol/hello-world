...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_ModuloReclamos_CategoriaProducto: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupTBL_Admin_Usuarios(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloReclamos_CategoriaProducto.Contains(this))
            {
                previousValue.TBL_ModuloReclamos_CategoriaProducto.Remove(this);
            }
    
            if (TBL_Admin_Usuarios != null)
            {
                if (!TBL_Admin_Usuarios.TBL_ModuloReclamos_CategoriaProducto.Contains(this))
                {
                    TBL_Admin_Usuarios.TBL_ModuloReclamos_CategoriaProducto.Add(this);
                }
        ...
        private void FixupTBL_Admin_Usuarios1(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloReclamos_CategoriaProducto1.Contains(this))
            {
                previousValue.TBL_ModuloReclamos_CategoriaProducto1.Remove(this);
            }
    
            if (TBL_Admin_Usuarios1 != null)
            {
                if (!TBL_Admin_Usuarios1.TBL_ModuloReclamos_CategoriaProducto1.Contains(this))
                {
                    TBL_Admin_Usuarios1.TBL_ModuloReclamos_CategoriaProducto1.Add(this);
                }
        ...
        private void FixupTBL_Admin_Usuarios2(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                ...
                {
                    if (!item.TBL_ModuloReclamos_CategoriaProducto2.Contains(this))
                    {
                        item.TBL_ModuloReclamos_CategoriaProducto2.Add(this);
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                foreach (TBL_Admin_Usuarios item in e.OldItems)
                {
                    if (item.TBL_ModuloReclamos_CategoriaProducto2.Contains(this))
                    {
                        item.TBL_ModuloReclamos_CategoriaProducto2.Remove(this);
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
