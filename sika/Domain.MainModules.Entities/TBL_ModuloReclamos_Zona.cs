...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_ModuloReclamos_Zona: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupTBL_Admin_Usuarios(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloReclamos_Zona.Contains(this))
            {
                previousValue.TBL_ModuloReclamos_Zona.Remove(this);
            }
    
            if (TBL_Admin_Usuarios != null)
            {
                if (!TBL_Admin_Usuarios.TBL_ModuloReclamos_Zona.Contains(this))
                {
                    TBL_Admin_Usuarios.TBL_ModuloReclamos_Zona.Add(this);
                }
        ...
        private void FixupTBL_Admin_Usuarios1(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloReclamos_Zona1.Contains(this))
            {
                previousValue.TBL_ModuloReclamos_Zona1.Remove(this);
            }
    
            if (TBL_Admin_Usuarios1 != null)
            {
                if (!TBL_Admin_Usuarios1.TBL_ModuloReclamos_Zona1.Contains(this))
                {
                    TBL_Admin_Usuarios1.TBL_ModuloReclamos_Zona1.Add(this);
                }
        ...
        private void FixupTBL_ModuloReclamos_Asesores(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                ...
                {
                    item.TBL_ModuloReclamos_Zona = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.TBL_ModuloReclamos_Zona, this))
                    {
                        item.TBL_ModuloReclamos_Zona = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
