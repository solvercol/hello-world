...
{
    public interface ISfTBL_ModuloAPC_ActividadesManagementServices : IGenericServices<TBL_ModuloAPC_Actividades>
    {
        TBL_ModuloAPC_Actividades GetById(decimal id);
        List<TBL_ModuloAPC_Actividades> GetByIdSolicitud(decimal idReclamo);
