...
{
    public interface ISfTBL_ModuloAPC_TrackingManagementServices : IGenericServices<TBL_ModuloAPC_Tracking>
    {

        List<TBL_ModuloAPC_Tracking> ListadoByIdSolicitud(int idSolicitud);
    }
}
