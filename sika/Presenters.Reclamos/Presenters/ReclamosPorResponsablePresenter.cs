...
{
    public class ReclamosPorResponsablePresenter : Presenter<IReclamosPorResponsableView>
    {
        ...
        public ReclamosPorResponsablePresenter(ISfTBL_ModuloReclamos_CategoriasReclamoManagementServices categoriasReclamoService
        ...
        public void LoadReport()
        {
            try
            {
                var dt = _recladoAdoService.GetVistaGestionReclamos(View.ServerHostPath, View.IdModule, View.UserSession.IdUser, View.FechaFilterFrom, View.FechaFilterTo
                                                                    , View.FilterNoReclamo, View.FilterCliente, View.FilterProducto, View.FilterServicio, "recresponsable");
