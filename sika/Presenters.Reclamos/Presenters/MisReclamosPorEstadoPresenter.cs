...
{
    public class MisReclamosPorEstadoPresenter : Presenter<IMisReclamosPorEstadoView>
    {
        ...
        public MisReclamosPorEstadoPresenter(ISfTBL_ModuloReclamos_CategoriasReclamoManagementServices categoriasReclamoService
        ...
        public void LoadReport()
        {
            try
            {
                var dt = _recladoAdoService.GetVistaMisReclamosPorEstado(View.FechaFilterFrom, View.FechaFilterTo, View.ServerHostPath, View.IdModule
