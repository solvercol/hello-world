...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_ModuloReclamos_AnexosActividad: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public decimal IdActividad
        {
            ...
            set
            {
                if (_idActividad != value)
                {
                    ...
                    if (!IsDeserializing)
                    {
                        if (TBL_ModuloReclamos_Actividades != null && TBL_ModuloReclamos_Actividades.IdActividad != value)
                        {
                            TBL_ModuloReclamos_Actividades = null;
                        }
                    }
                    _idActividad = value;
        ...
        [DataMember]
        public TBL_ModuloReclamos_Actividades TBL_ModuloReclamos_Actividades
        {
            get { return _tBL_ModuloReclamos_Actividades; }
            set
            {
                if (!ReferenceEquals(_tBL_ModuloReclamos_Actividades, value))
                {
                    var previousValue = _tBL_ModuloReclamos_Actividades;
                    _tBL_ModuloReclamos_Actividades = value;
                    FixupTBL_ModuloReclamos_Actividades(previousValue);
                    OnNavigationPropertyChanged("TBL_ModuloReclamos_Actividades");
                }
            }
        }
        private TBL_ModuloReclamos_Actividades _tBL_ModuloReclamos_Actividades;
        ...
        private void FixupTBL_Admin_Usuarios(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloReclamos_AnexosActividad.Contains(this))
            {
                previousValue.TBL_ModuloReclamos_AnexosActividad.Remove(this);
            }
    
            if (TBL_Admin_Usuarios != null)
            {
                if (!TBL_Admin_Usuarios.TBL_ModuloReclamos_AnexosActividad.Contains(this))
                {
                    TBL_Admin_Usuarios.TBL_ModuloReclamos_AnexosActividad.Add(this);
                }
        ...
        private void FixupTBL_Admin_Usuarios1(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloReclamos_AnexosActividad1.Contains(this))
            {
                previousValue.TBL_ModuloReclamos_AnexosActividad1.Remove(this);
            }
    
            if (TBL_Admin_Usuarios1 != null)
            {
                if (!TBL_Admin_Usuarios1.TBL_ModuloReclamos_AnexosActividad1.Contains(this))
                {
                    TBL_Admin_Usuarios1.TBL_ModuloReclamos_AnexosActividad1.Add(this);
                }
        ...
        private void FixupTBL_ModuloReclamos_Actividades(TBL_ModuloReclamos_Actividades previousValue)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (TBL_ModuloReclamos_Actividades != null)
            {
                if (!TBL_ModuloReclamos_Actividades.TBL_ModuloReclamos_AnexosActividad.Contains(this))
                {
                    TBL_ModuloReclamos_Actividades.TBL_ModuloReclamos_AnexosActividad.Add(this);
                }
    
                IdActividad = TBL_ModuloReclamos_Actividades.IdActividad;
            }
            if (ChangeTracker.ChangeTrackingEnabled)
            {
                if (ChangeTracker.OriginalValues.ContainsKey("TBL_ModuloReclamos_Actividades")
                    && (ChangeTracker.OriginalValues["TBL_ModuloReclamos_Actividades"] == TBL_ModuloReclamos_Actividades))
                {
                    ChangeTracker.OriginalValues.Remove("TBL_ModuloReclamos_Actividades");
                }
                else
                {
                    ChangeTracker.RecordOriginalValue("TBL_ModuloReclamos_Actividades", previousValue);
                }
                if (TBL_ModuloReclamos_Actividades != null && !TBL_ModuloReclamos_Actividades.ChangeTracker.ChangeTrackingEnabled)
                {
                    TBL_ModuloReclamos_Actividades.StartTracking();
                }
            }
        }
