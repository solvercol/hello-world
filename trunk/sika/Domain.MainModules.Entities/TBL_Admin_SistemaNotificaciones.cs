...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_Admin_SistemaNotificaciones: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int IdNotificacion
        {
            ...
            set
            {
                if (_idNotificacion != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'IdNotificacion' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _idNotificacion = value;
                    OnPropertyChanged("IdNotificacion");
                }
            }
        }
        ...
        public int IdUser
        {
            ...
            set
            {
                if (_idUser != value)
                {
                    ChangeTracker.RecordOriginalValue("IdUser", _idUser);
                    if (!IsDeserializing)
                    {
        ...
        private void FixupTBL_Admin_Usuarios(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_Admin_SistemaNotificaciones.Contains(this))
            {
                previousValue.TBL_Admin_SistemaNotificaciones.Remove(this);
            }
    
            if (TBL_Admin_Usuarios != null)
            {
                if (!TBL_Admin_Usuarios.TBL_Admin_SistemaNotificaciones.Contains(this))
                {
                    TBL_Admin_Usuarios.TBL_Admin_SistemaNotificaciones.Add(this);
                }
    
                IdUser = TBL_Admin_Usuarios.IdUser;
            }
