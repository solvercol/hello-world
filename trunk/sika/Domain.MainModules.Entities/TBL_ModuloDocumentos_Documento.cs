...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_ModuloDocumentos_Documento: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupTBL_Admin_Usuarios(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloDocumentos_Documento.Contains(this))
            {
                previousValue.TBL_ModuloDocumentos_Documento.Remove(this);
            }
    
            if (TBL_Admin_Usuarios != null)
            {
                if (!TBL_Admin_Usuarios.TBL_ModuloDocumentos_Documento.Contains(this))
                {
        ...
        private void FixupTBL_Admin_Usuarios1(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloDocumentos_Documento1.Contains(this))
            {
                previousValue.TBL_ModuloDocumentos_Documento1.Remove(this);
            }
    
            if (TBL_Admin_Usuarios1 != null)
            {
                if (!TBL_Admin_Usuarios1.TBL_ModuloDocumentos_Documento1.Contains(this))
                {
        ...
        private void FixupTBL_ModuloDocumentos_Categorias(TBL_ModuloDocumentos_Categorias previousValue)
        {
            ...
            {
                if (!TBL_ModuloDocumentos_Categorias.TBL_ModuloDocumentos_Documento.Contains(this))
                {
                    TBL_ModuloDocumentos_Categorias.TBL_ModuloDocumentos_Documento.Add(this);
                }
        ...
        private void FixupTBL_ModuloDocumentos_Categorias1(TBL_ModuloDocumentos_Categorias previousValue)
        {
            ...
            {
                if (!TBL_ModuloDocumentos_Categorias1.TBL_ModuloDocumentos_Documento1.Contains(this))
                {
                    TBL_ModuloDocumentos_Categorias1.TBL_ModuloDocumentos_Documento1.Add(this);
                }
        ...
        private void FixupTBL_ModuloDocumentos_Categorias2(TBL_ModuloDocumentos_Categorias previousValue)
        {
            ...
            {
                if (!TBL_ModuloDocumentos_Categorias2.TBL_ModuloDocumentos_Documento2.Contains(this))
                {
                    TBL_ModuloDocumentos_Categorias2.TBL_ModuloDocumentos_Documento2.Add(this);
                }
        ...
        private void FixupTBL_ModuloDocumentos_Estados(TBL_ModuloDocumentos_Estados previousValue, bool skipKeys = false)
        {
            if (IsDeserializing)
            {
                return;
            ...
            {
                if (!TBL_ModuloDocumentos_Estados.TBL_ModuloDocumentos_Documento.Contains(this))
                {
                    TBL_ModuloDocumentos_Estados.TBL_ModuloDocumentos_Documento.Add(this);
                }
