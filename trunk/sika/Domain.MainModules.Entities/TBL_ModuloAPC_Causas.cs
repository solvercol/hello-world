...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_ModuloAPC_Causas: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public decimal IdCausa
        {
            ...
            set
            {
                if (_idCausa != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'IdCausa' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _idCausa = value;
                    OnPropertyChanged("IdCausa");
                }
            }
        }
        private decimal _idCausa;
        ...
        private void FixupTBL_Admin_Usuarios(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloAPC_Causas.Contains(this))
            {
                previousValue.TBL_ModuloAPC_Causas.Remove(this);
            }
    
            if (TBL_Admin_Usuarios != null)
            {
                if (!TBL_Admin_Usuarios.TBL_ModuloAPC_Causas.Contains(this))
                {
                    TBL_Admin_Usuarios.TBL_ModuloAPC_Causas.Add(this);
                }
        ...
        private void FixupTBL_Admin_Usuarios1(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloAPC_Causas1.Contains(this))
            {
                previousValue.TBL_ModuloAPC_Causas1.Remove(this);
            }
    
            if (TBL_Admin_Usuarios1 != null)
            {
                if (!TBL_Admin_Usuarios1.TBL_ModuloAPC_Causas1.Contains(this))
                {
                    TBL_Admin_Usuarios1.TBL_ModuloAPC_Causas1.Add(this);
                }
        ...
        private void FixupTBL_ModuloAPC_Solicitud(TBL_ModuloAPC_Solicitud previousValue)
        {
            ...
            {
                if (!TBL_ModuloAPC_Solicitud.TBL_ModuloAPC_Causas.Contains(this))
                {
                    TBL_ModuloAPC_Solicitud.TBL_ModuloAPC_Causas.Add(this);
                }
