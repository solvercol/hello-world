...
namespace Domain.MainModules.Entities
{
    ...
    public partial class TBL_ModuloAPC_Areas: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int IdArea
        {
            ...
            set
            {
                if (_idArea != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'IdArea' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _idArea = value;
                    OnPropertyChanged("IdArea");
                }
            }
        }
        private int _idArea;
        ...
        private void FixupTBL_Admin_Usuarios(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloAPC_Areas.Contains(this))
            {
                previousValue.TBL_ModuloAPC_Areas.Remove(this);
            }
    
            if (TBL_Admin_Usuarios != null)
            {
                if (!TBL_Admin_Usuarios.TBL_ModuloAPC_Areas.Contains(this))
                {
                    TBL_Admin_Usuarios.TBL_ModuloAPC_Areas.Add(this);
                }
        ...
        private void FixupTBL_Admin_Usuarios1(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloAPC_Areas1.Contains(this))
            {
                previousValue.TBL_ModuloAPC_Areas1.Remove(this);
            }
    
            if (TBL_Admin_Usuarios1 != null)
            {
                if (!TBL_Admin_Usuarios1.TBL_ModuloAPC_Areas1.Contains(this))
                {
                    TBL_Admin_Usuarios1.TBL_ModuloAPC_Areas1.Add(this);
                }
        ...
        private void FixupTBL_Admin_Usuarios2(TBL_Admin_Usuarios previousValue)
        {
            ...
            if (previousValue != null && previousValue.TBL_ModuloAPC_Areas2.Contains(this))
            {
                previousValue.TBL_ModuloAPC_Areas2.Remove(this);
            }
    
            if (TBL_Admin_Usuarios2 != null)
            {
                if (!TBL_Admin_Usuarios2.TBL_ModuloAPC_Areas2.Contains(this))
                {
                    TBL_Admin_Usuarios2.TBL_ModuloAPC_Areas2.Add(this);
                }
        ...
        private void FixupTBL_ModuloAPC_Solicitud(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.TBL_ModuloAPC_Areas, this))
                    {
                        item.TBL_ModuloAPC_Areas = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
