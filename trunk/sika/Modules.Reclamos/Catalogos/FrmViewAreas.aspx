<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmViewAreas.aspx.cs" Inherits="Modules.Reclamos.Catalogos.FrmViewAreas" %>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <div id="divPanelShow">
                ...
                <asp:button id="btnNew" runat="server" Visible="true" OnClick="BtnNewClick" text="Nueva Área"></asp:button>
            </td>
        </tr>
    </table>
