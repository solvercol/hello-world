<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmAdminAsesores.aspx.cs" Inherits="Modules.Reclamos.Catalogos.FrmAdminAsesores" %>
                    ...
                    OnItemDataBound="RptListadoItemDataBound">
	                    <headertemplate>
		                    <tr>
		                        ...
		                        <th style="width:190px;">Jefe(s) inmediato(s)</th>
			                    <th style="width:30px;"></th>
		                    </tr>
	                    </headertemplate>
	                    <itemtemplate>
		                    <tr>
                                <td align="left"><asp:Literal ID="litAsesor" runat="server"></asp:Literal></td>
                                ...
                                <td align="left"><asp:Literal ID="litJefe" runat="server"></asp:Literal></td>
			                    <td align="center">
