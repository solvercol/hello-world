<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmAdminCategoriasProductos.aspx.cs" Inherits="Modules.Reclamos.Catalogos.FrmAdminCategoriasProductos" %>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <div id="divPanelShow">
                ...
                <asp:button id="btnNew" runat="server" Visible="true" OnClick="BtnNewClick" text="Nueva Categoría Producto"></asp:button>
            </td>
        </tr>
    </table>
    ...
    <tr>  
        <td >
                ...
                <ContentTemplate>
                    ...
                    OnItemDataBound="RptListadoItemDataBound">
	                    <headertemplate>
		                    <tr>
			                    ...
			                    <th style="width:190px;">Ingenieros Responsables</th>
	                    ...
	                    <itemtemplate>
		                    <tr>
                                <td align="left"><asp:Literal ID="litCategoria" runat="server"></asp:Literal></td>
		                        <td align="left"><asp:Literal ID="litIngenieros" runat="server"></asp:Literal></td>
                    ...
                    <div class="pager">
				            <csc:PagerLinq ID="pgrListado" runat="server" PageSize="5" OnPageChanged="PgrChanged"/>
	                </div>	
                </ContentTemplate>
                </asp:UpdatePanel>            
        </td>
