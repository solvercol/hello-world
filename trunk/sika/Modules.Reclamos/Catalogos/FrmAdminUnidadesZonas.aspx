<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmAdminUnidadesZonas.aspx.cs" Inherits="Modules.Reclamos.Catalogos.FrmAdminUnidadesZonas" %>
        ...
        <tr>
            ...
            <div id="divPanelShow">
                <div style="float: left; vertical-align: middle;" id="PnlFiltroHeader">
                 ...
                 <asp:button id="btnNew" runat="server" Visible="true" OnClick="BtnNewClick" text="Nueva Unidad Zona"></asp:button>
            </td>
        </tr>
    </table>
                    ...
                    OnItemDataBound="RptListadoItemDataBound">
	                    <headertemplate>
		                    <tr>
		                        ...
		                        <th style="width:190px;">Zona</th>
			                    <th style="width:190px;">Descripción</th>
                                <th style="width:150px;">Gerente</th>
                                <th style="width:150px;">Tarifa Fletes</th>
			                    <th style="width:30px;"></th>
		                    </tr>
	                    </headertemplate>
	                    <itemtemplate>
		                    <tr>
                                <td align="left"><asp:Literal ID="litUnidad" runat="server"></asp:Literal></td>
		                        <td align="left"><asp:Literal ID="litZona" runat="server"></asp:Literal></td>
                                ...
                                <td align="right"><asp:Literal ID="litTarifa"  runat="server"></asp:Literal></td>
