<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmEditCategoriaReclamo.aspx.cs" Inherits="Modules.Reclamos.Catalogos.FrmEditCategoriaReclamo" %>
				    ...
				    <table id="userdetails" width="100%">
                        ...
                        <tr>
						    ...
						    <td align="left" class="bordeTabla">
                             <asp:RadioButtonList ID="wddReclamo" RepeatDirection="Horizontal" CssClass="radioButtonList" runat="server" onselectedindexchanged="wddReclamo_SelectedIndexChanged" AutoPostBack="true" ></asp:RadioButtonList>
