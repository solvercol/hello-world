...
{
    public partial class FrmReclamosPorProducto : ViewPage<ReclamosPorProductoPresenter, IReclamosPorProductoView>, IReclamosPorProductoView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Reclamos Por Producto");
        }
        ...
        public void LoadViewReclamos(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/Reclamos/Resources/ReportViewer/RptVistaReclamosPorProducto.rdlc");
