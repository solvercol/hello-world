...
{
    public partial class FrmReclamosExport : ViewPage<ReclamosExportPresenter, IReclamosExportView>, IReclamosExportView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Total Reclamos Exportación");
        }
        ...
        public void LoadViewReclamos(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/Reclamos/Resources/ReportViewer/RptVistaReclamosExport.rdlc");
