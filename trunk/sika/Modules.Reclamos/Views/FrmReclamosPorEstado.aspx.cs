...
{
    public partial class FrmReclamosPorEstado : ViewPage<ReclamosPorEstadoPresenter, IReclamosPorEstadoView>, IReclamosPorEstadoView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Reclamos Por Estado");
        }
