<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmMisPendientes.aspx.cs" Inherits="Modules.Reclamos.Views.FrmMisPendientes" %>
...
<asp:Panel ID="pReporte" runat="server" style="padding-bottom: 30px;" width="99%" Height="500px" ScrollBars="Auto">                
    <rsweb:ReportViewer ID="rptReclamos" runat="server" Width="100%" Height="100%" CssClass="FontFamilyMain"
