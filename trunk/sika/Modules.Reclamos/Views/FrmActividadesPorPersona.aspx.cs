...
{
    public partial class FrmActividadesPorPersona : ViewPage<ActividadesPorPersonaPresenter, IActividadesPorPersonaView>, IActividadesPorPersonaView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Actividades Por Persona");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/Reclamos/Resources/ReportViewer/RptVistaActividadesPorPersona.rdlc");
