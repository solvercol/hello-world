...
{
    public partial class FrmMisPendientes : ViewPage<MisPendientesPresenter, IMisPendientesView>, IMisPendientesView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Mis Reclamos Pendientes");
        }
        ...
        protected void BtnConfirmNuevoReclamo_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect(string.Format("../Admin/FrmAddReclamo.aspx?ModuleId={0}&tr={1}&from=pendientes", ModuleId, TipoReclamo));
            }
            else
            {
                Response.Redirect(string.Format("../Admin/FrmAddReclamo.aspx?ModuleId={0}&tr={1}&cat={2}&gruinf={3}&from=pendientes",
        ...
        public void LoadViewReclamos(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/Reclamos/Resources/ReportViewer/RptVistaReclamosMisPendientes.rdlc");
