...
{
    public partial class FrmReclamosPorAutor : ViewPage<ReclamosPorAutorPresenter, IReclamosPorAutorView>, IReclamosPorAutorView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Reclamos Por Autor");
        }
