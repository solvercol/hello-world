...
{
    public partial class FrmReclamosPorNumero : ViewPage<ReclamosPorNumeroPresenter, IReclamosPorNumeroView>, IReclamosPorNumeroView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Reclamos Por Numero");
        }
