...
{
    public partial class FrmReclamosPorFecha : ViewPage<ReclamosPorFechaPresenter, IReclamosPorFechaView>, IReclamosPorFechaView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Reclamos Por Fecha");
        }
