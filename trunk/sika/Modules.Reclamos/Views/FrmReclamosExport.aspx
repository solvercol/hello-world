...
<div style="padding-bottom:5px; background-color:#FAFAFA;">
    ...
    <asp:Panel id="PanelFiltro" CssClass="FondoSeccionFiltro" runat="server"  style="display:none;" Width="98%" >
        ...
        <table class="tblSecciones" width="100%">
            ...
            <tr>
                <td>
                    <asp:TextBox ID="txtNoReclamo" runat="server" Width="125px" />
                </td>
                <td></td>
                <td>
                    <asp:TextBox ID="txtNoRelacion" runat="server" Width="125px" />
                </td>
                <td></td>
                <td>
                    <asp:TextBox ID="txtCliente" runat="server" Width="125px" />
                </td>
                <td></td>
                <td>
                    <asp:TextBox ID="txtProducto" runat="server" Width="125px" />
                </td>
                <td></td>
                <td>
                    <asp:TextBox ID="txtServicio" runat="server" Width="125px" />
                </td>
                <td></td>
                <td>
                    <table width="100%">
