...
{
    public partial class FrmReclamosPorTipo : ViewPage<ReclamosPorTipoPresenter, IReclamosPorTipoView>, IReclamosPorTipoView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Reclamos Por Tipo");
        }
        ...
        protected void BtnConfirmNuevoReclamo_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect(string.Format("../Admin/FrmAddReclamo.aspx?ModuleId={0}&tr={1}&from=rectipo", ModuleId, TipoReclamo));
            }
            else
            {
                Response.Redirect(string.Format("../Admin/FrmAddReclamo.aspx?ModuleId={0}&tr={1}&cat={2}&gruinf={3}&from=rectipo",
        ...
        public void LoadViewReclamos(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/Reclamos/Resources/ReportViewer/RptVistaReclamosPorTipo.rdlc");
