...
{
    public partial class FrmReclamosPorCliente : ViewPage<ReclamosPorClientePresenter, IReclamosPorClienteView>, IReclamosPorClienteView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Reclamos Por Cliente");
        }
        ...
        public void LoadViewReclamos(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/Reclamos/Resources/ReportViewer/RptVistaReclamosPorCliente.rdlc");
