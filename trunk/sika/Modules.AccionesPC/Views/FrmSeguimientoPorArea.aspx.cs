...
{
    public partial class FrmSeguimientoPorArea : ViewPage<SeguimientoPorAreaPresenter, ISeguimientoPorAreaView>, ISeguimientoPorAreaView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Seguimiento Por Area");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/AccionesPC/Resources/ReportViewer/RptSeguimientoPorArea.rdlc");
