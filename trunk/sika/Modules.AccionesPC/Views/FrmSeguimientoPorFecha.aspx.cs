...
{
    public partial class FrmSeguimientoPorFecha : ViewPage<SeguimientoPorFechaPresenter, ISeguimientoPorFechaView>, ISeguimientoPorFechaView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Seguimiento Por Fecha");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/AccionesPC/Resources/ReportViewer/RptSeguimientoPorFecha.rdlc");
