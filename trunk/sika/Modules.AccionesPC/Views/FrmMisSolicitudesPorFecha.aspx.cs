...
{
    public partial class FrmMisSolicitudesPorFecha : ViewPage<MisSolicitudesPorFechaPresenter, IMisSolicitudesPorFechaView>, IMisSolicitudesPorFechaView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Mis Solicitudes Por Fecha");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/AccionesPC/Resources/ReportViewer/RptMisSolicitudesPorFecha.rdlc");
