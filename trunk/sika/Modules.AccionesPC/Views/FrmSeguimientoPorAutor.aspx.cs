...
{
    public partial class FrmSeguimientoPorAutor : ViewPage<SeguimientoPorAutorPresenter, ISeguimientoPorAutorView>, ISeguimientoPorAutorView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Seguimiento Por Autor");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/AccionesPC/Resources/ReportViewer/RptSeguimientoPorAutor.rdlc");
