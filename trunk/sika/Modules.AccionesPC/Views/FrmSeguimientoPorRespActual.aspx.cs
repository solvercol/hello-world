...
{
    public partial class FrmSeguimientoPorRespActual : ViewPage<SeguimientoPorRespActualPresenter, ISeguimientoPorRespActualView>, ISeguimientoPorRespActualView
    {
        #region Page Events
        ...
        {
            ImprimirTituloVentana("Seguimiento Por Responsable Actual");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/AccionesPC/Resources/ReportViewer/RptSeguimientoPorResponsableActual.rdlc");
