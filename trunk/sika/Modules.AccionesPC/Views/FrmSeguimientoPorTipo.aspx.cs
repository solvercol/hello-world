...
namespace Modules.AccionesPC.Views
{
    public partial class FrmSeguimientoPorTipo : ViewPage<SeguimientoPorTipoPresenter, ISeguimientoPorTipoView>, ISeguimientoPorTipoView
    {
        ...
        {
            ImprimirTituloVentana("Seguimiento Por Tipo");
        }
        ...
        public void LoadView(DataTable dt)
        {
            ...
            rptReclamos.LocalReport.ReportPath = Server.MapPath(@"~/Pages/Modules/AccionesPC/Resources/ReportViewer/RptSeguimientoPorTipo.rdlc");
