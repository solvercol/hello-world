...
namespace Application.MainModule.SqlServices.IServices
{
    public interface IPedidosEmpacorServices
    {
        ...
        /// <summary>
        ///  Obtiene el DatatTable con los campos del pedido para ser mapeados en los campos de la ruta del WorkFlow
        /// </summary>
        /// <param name="idPedido"></param>
        /// <returns></returns>
        DataTable GetPedidoWorkFlowByIdPedido(string idPedido);
        ...
        /// <param name="idPedido"></param>
        /// <returns></returns>
        string EstadoPedido(string idPedido);

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        bool VerificarSuministros(string sp);

        /// <summary>
        /// Obtiene los valores del pedido asociados al panel de resumen donde se lista el estado, responsable, solicitante, etc.
        /// </summary>
        /// <param name="idPedido"></param>
        /// <returns></returns>
        DataTable GetResumenPedidos(string idPedido);

        /// <summary>
        /// Retorna el nombre del cliete dueño del pedido
        /// </summary>
        /// <param name="idPedido"></param>
        /// <returns></returns>
        string RetornarNombreClienteByIdPedido(string idPedido);
