...
{
    public class ReadingReclamoServicioT3DetallePresenter : Presenter<IReadingReclamoServicioT3DetalleView>
    {
        readonly ISfTBL_ModuloReclamos_ReclamoManagementServices _reclamoService;

        public ReadingReclamoServicioT3DetallePresenter(ISfTBL_ModuloReclamos_ReclamoManagementServices reclamoService)
        {
