IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'Vistas_GestionReclamo') AND type in (N'P', N'PC'))
DROP PROCEDURE Vistas_GestionReclamo
GO
-- =============================================
-- Author:		Solver
...
-- Description:
-- =============================================
CREATE PROCEDURE Vistas_GestionReclamo
(
