...
namespace Presenters.AccionesPC.Presenters
{
    public class MisActividadesPendientesPresenter : Presenter<IMisActividadesPendientesView>
    {
        ...
        public MisActividadesPendientesPresenter(ISfTBL_ModuloAPC_AreasManagementServices areasService, ISolicitudesAPCAdoService solicitudesAdoService, ISfTBL_Admin_OptionListManagementServices optionListService)
        {
        ...
        public void LoadView()
        {
            try
            {
                var dt = _solicitudesAdoService.GetVistaActividades(View.FechaFilterFrom, View.FechaFilterTo, View.ServerHostPath, View.IdModule, "misactpend"
                                                                         , View.FilterNoSolicitud, View.FilterTipo, View.FilterArea, View.FilterProceso, "Programada", View.UserSession.IdUser);
                View.LoadView(dt);
            }
            catch (Exception ex)
            {
