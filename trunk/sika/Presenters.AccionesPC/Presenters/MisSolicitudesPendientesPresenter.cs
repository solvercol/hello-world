...
namespace Presenters.AccionesPC.Presenters
{
    public class MisSolicitudesPendientesPresenter : Presenter<IMisSolicitudesPendientesView>
    {
        ...
        public MisSolicitudesPendientesPresenter(ISfTBL_ModuloAPC_AreasManagementServices areasService, ISolicitudesAPCAdoService solicitudesAdoService, ISfTBL_Admin_OptionListManagementServices optionListService)
        {
