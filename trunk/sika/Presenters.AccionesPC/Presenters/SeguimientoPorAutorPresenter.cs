...
{
    public class SeguimientoPorAutorPresenter : Presenter<ISeguimientoPorAutorView>
    {
        ...
        public SeguimientoPorAutorPresenter(ISfTBL_ModuloAPC_AreasManagementServices areasService, ISolicitudesAPCAdoService solicitudesAdoService, ISfTBL_Admin_OptionListManagementServices optionListService)
        {
        ...
        public void LoadView()
        {
            try
            {
                var dt = _solicitudesAdoService.GetVistaSeguimiento(View.FechaFilterFrom, View.FechaFilterTo, View.ServerHostPath, View.IdModule, "segautor"
