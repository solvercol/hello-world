...
namespace Presenters.AccionesPC.Presenters
{
    public class ActividadesPorPersonaPresenter : Presenter<IActividadesPorPersonaView>
    {
        ...
        public ActividadesPorPersonaPresenter(ISfTBL_ModuloAPC_AreasManagementServices areasService, ISolicitudesAPCAdoService solicitudesAdoService, ISfTBL_Admin_OptionListManagementServices optionListService)
        {
        ...
        public void LoadView()
        {
            try
            {
                var dt = _solicitudesAdoService.GetVistaActividades(View.FechaFilterFrom, View.FechaFilterTo, View.ServerHostPath, View.IdModule, "actpersona"
                                                                         , View.FilterNoSolicitud, View.FilterTipo, View.FilterArea, View.FilterProceso, "", 0);
                View.LoadView(dt);
            }
            catch (Exception ex)
            {
