...
namespace Application.MainModule.IApplicationServices
{
    public interface ISfTBL_Admin_RutasWorkFlowManagementServices : IGenericServices<TBL_Admin_RutasWorkFlow>
    {
