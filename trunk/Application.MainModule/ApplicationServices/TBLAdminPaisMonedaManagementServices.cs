...
namespace Application.MainModule.ApplicationServices
{
    public class SfTBL_Admin_PaisMonedaManagementServices : ISfTBL_Admin_PaisMonedaManagementServices
    {
         ...
         public TBL_Admin_PaisMoneda FindById(string id)
         {
             if (string.IsNullOrEmpty(id))
                 throw new ArgumentNullException(string.Format("Busqueda por Id : El parametro es nulo."));

              Specification<TBL_Admin_PaisMoneda> specification = new DirectSpecification<TBL_Admin_PaisMoneda>(u => u.Code == id);
         ...
         {
            Specification<TBL_Admin_PaisMoneda> specification = new DirectSpecification<TBL_Admin_PaisMoneda>(u => u.IsActive == isActive);
         ...
         public List<TBL_Admin_PaisMoneda> FindPaged(int pageIndex, int pageCount)
         {
            ...
            Specification<TBL_Admin_PaisMoneda> onlyEnabledSpec = new DirectSpecification<TBL_Admin_PaisMoneda>(u => u.IsActive);

            return _TBLAdminPaisMonedaRepository.GetPagedElements(pageIndex, pageCount, u => u.Code, onlyEnabledSpec, true).ToList();
         }
