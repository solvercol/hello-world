    ...
    public class SfTBL_Admin_PaisesManagementServices : ISfTBL_Admin_PaisesManagementServices
    {
         ...
         public TBL_Admin_Paises FindById(int id)
         {
           /* if (id == 0)
            ...
            Specification<TBL_Admin_Paises> specification = new DirectSpecification<TBL_Admin_Paises>(u => u.ID == id);
         ...
         public TBL_Admin_Paises FindById(string id)
         {
             if (string.IsNullOrEmpty(id))
                 throw new ArgumentNullException(string.Format("Busqueda por Id : El parametro es nulo."));

              Specification<TBL_Admin_Paises> specification = new DirectSpecification<TBL_Admin_Paises>(u => u.Code == id);
         ...
         public List<TBL_Admin_Paises> FindPaged(int pageIndex, int pageCount)
         {
            ...
            return _TBLAdminPaisesRepository.GetPagedElements(pageIndex, pageCount, u => u.Code, onlyEnabledSpec, true).ToList();
         }
