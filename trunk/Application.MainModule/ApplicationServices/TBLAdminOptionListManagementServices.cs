    ...
    public class SfTBL_Admin_OptionListManagementServices : ISfTBL_Admin_OptionListManagementServices
    {
         ...
         public TBL_Admin_OptionList FindById(int id)
         {
           /* if (id == 0)
            ...
            Specification<TBL_Admin_OptionList> specification = new DirectSpecification<TBL_Admin_OptionList>(u => u.ID == id);
         ...
         public TBL_Admin_OptionList FindById(string id)
         {
             if (string.IsNullOrEmpty(id))
                 throw new ArgumentNullException(string.Format("Busqueda por Id : El parametro es nulo."));

              Specification<TBL_Admin_OptionList> specification = new DirectSpecification<TBL_Admin_OptionList>(u => u.Code == id);
         ...
         public List<TBL_Admin_OptionList> FindPaged(int pageIndex, int pageCount)
         {
            ...
            return _TBLAdminOptionListRepository.GetPagedElements(pageIndex, pageCount, u => u.Code, onlyEnabledSpec, true).ToList();
         }
